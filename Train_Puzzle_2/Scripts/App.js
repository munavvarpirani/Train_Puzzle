        ...
        for (let i = 0; i < carts.length; i++) {
            if (carts[i].progress < 100) {
                ...
                if (state.autoplay) {
                    ...
                    NextLevel2(true, false);
                    NextLevel3(true, false);
                } else {
                    document.body.classList.remove('game--active');
...
const playLevel = (autoplay, paused) => {
    ...
    let diffSlider = state.train.speed = 0.10;
    if (!autoplay) {
    ...
    state.map = new Map(levelFactory.newLevel(diffSlider, false));
    ...
    state.train = {
        tile: null,
        prevTiles: [],
        speed: map(diffSlider, 1, 100, 0, 1),
        speed: 0.10,
        dir: null
    };
    SecondRound = 0;
...
const NextLevel = (autoplay, paused) => {
    /*debugger;*/
    Reset();
    let diffSlider = state.train.speed = 0.15;
    if (!autoplay) {
        document.body.classList.add('game--active');
    } else {
        document.body.classList.remove('game--active');
...
const NextLevel2 = (autoplay, paused) => {
    Reset();
    let diffSlider = state.train.speed = 0.30;
    if (!autoplay) {
        document.body.classList.add('game--active');
    } else {
        document.body.classList.remove('game--active');
...
const NextLevel3 = (autoplay, paused) => {
    Reset();
    let diffSlider = state.train.speed = 0.40;
    if (!autoplay) {
        document.body.classList.add('game--active');
    } else {
        document.body.classList.remove('game--active');
...
const NextLevel4 = (autoplay, paused) => {
    Reset();
    let diffSlider = state.train.speed = 0.50;
    if (!autoplay) {
        document.body.classList.add('game--active');
    } else {
        document.body.classList.remove('game--active');
...
const NextLevel5 = (autoplay, paused) => {
    Reset();
    let diffSlider = state.train.speed = 0.60;
    if (!autoplay) {
        document.body.classList.add('game--active');
    } else {
        document.body.classList.remove('game--active');
...
const NextLevel6 = (autoplay, paused) => {
    Reset();
    let diffSlider = state.train.speed = 0.70;
    if (!autoplay) {
        document.body.classList.add('game--active');
    } else {
        document.body.classList.remove('game--active');
...
const NextLevel7 = (autoplay, paused) => {
    Reset();
    let diffSlider = state.train.speed = 0.80;
    if (!autoplay) {
        document.body.classList.add('game--active');
    } else {
        document.body.classList.remove('game--active');
...
const NextLevel8 = (autoplay, paused) => {
    Reset();
    let diffSlider = state.train.speed = 0.90;
    if (!autoplay) {
        document.body.classList.add('game--active');
    } else {
        document.body.classList.remove('game--active');
...
const NextLevel9 = (autoplay, paused) => {
    Reset();
    let diffSlider = state.train.speed = 0.99;
    if (!autoplay) {
        document.body.classList.add('game--active');
    } else {
        document.body.classList.remove('game--active');
...
const gotoMenu = (autoplay, paused) => {
